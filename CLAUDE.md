...
**Next up:** F30, deployment (see `IMPLEMENTATION_PLAN.md`): needs the host, domain and permission to deploy. Outstanding: the k6 spike regression (DECISIONS, F23); more than one ingest replica is the obvious next step there.
