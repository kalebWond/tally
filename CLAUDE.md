...
**Last completed:** F29, counting backlog (2026-09-24)
**Next up:** F30, UI polish (planned, waiting for the go-ahead); then F31, deployment, which needs the host, domain and permission to deploy (see `IMPLEMENTATION_PLAN.md`). Outstanding: the k6 spike regression (DECISIONS, F23); more than one ingest replica is the obvious next step there.
