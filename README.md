...
The full write-up (architecture, decisions and trade-offs) comes in F33. Until then, [`SPEC.md`](SPEC.md) describes the system and [`DECISIONS.md`](DECISIONS.md) records every choice along the way.
